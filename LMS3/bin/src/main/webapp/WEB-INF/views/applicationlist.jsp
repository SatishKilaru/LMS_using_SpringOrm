			...
			<tbody>
				...
				<tr>
					...
					<td><form action="view" method="post">
							<input type="hidden" name="id" value="<%=e.getLnap_id()%>"%><input
				...
				.ready(
						function() {
							...
							function filterTable() {
								var minLoanAmount = parseFloat($(
										"#minLoanAmount").val());
								var maxLoanAmount = parseFloat($(
										"#maxLoanAmount").val());
								...
								$("tbody tr")
										.each(
												function() {
													var row = $(this);
													var rowLoanAmount = parseFloat(row
															.find(
																	"td:nth-child(6)")
															.text());
													var rowStatus = row.find(
															"td:nth-child(11)")
															.text(); // Assuming the "Status" column is the 11th column.
