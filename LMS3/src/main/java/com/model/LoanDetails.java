...
public class LoanDetails {
	...
	public int getLnap_amount() {
		return lnap_amount;
	}

	public int getLnap_emi_range_from() {
		return lnap_emi_range_from;
	}

	public int getLnap_emi_range_to() {
	...
	public void setLnap_amount(int lnap_amount) {
		this.lnap_amount = lnap_amount;
	}

	public void setLnap_emi_range_from(int lnap_emi_range_from) {
		this.lnap_emi_range_from = lnap_emi_range_from;
	}

	public void setLnap_emi_range_to(int lnap_emi_range_to) {
