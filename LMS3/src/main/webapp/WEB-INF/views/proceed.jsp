		...
		<div class="form-box">
			...
			<div class="form-part" style="display: none;">
				...
				<b>Amount : </b> <input type="text" name="lnap_amount"
					placeholder="Enter Amount"  value="<%= request.getAttribute("amount") %>" readonly><br> <b>Applied Date :
					...
					placeholder="Enter Cibil Score" value="<%= request.getAttribute("cibil") %>" readonly><br>
